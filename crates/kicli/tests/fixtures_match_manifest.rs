...
//! dependency.
//!
//! `kicli-sexpr` carries a copy of this test for its own fixture root. The two
//! roots are independent, and sharing the code would make one crate read the
//! other crate's directory.
